...
public class StudentSearch {
 ...
 //Define the searchStudent method that takes an array of 
 //Student objects (students) and an integer rollNumber as parameters
 ...
 public static void main(String[] args) {
     ...
     //Call the searchStudent method, passing the students array 
	 //and targetRollNumber as arguments
